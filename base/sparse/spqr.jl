...
using ..SparseMatrix: SparseMatrixCSC
using ..SparseMatrix.CHOLMOD: C_Dense, C_Sparse, Dense, ITypes, Sparse, VTypes, common

import Base: size
import Base.LinAlg: qrfact
import ..SparseMatrix.CHOLMOD: convert, free!
